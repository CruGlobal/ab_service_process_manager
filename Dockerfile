...
## $ docker buildx build --provenance=true --sbom=true --platform linux/amd64,linux/arm64 -t digiserve/ab-process-manager:master --push .
...
LABEL org.opencontainers.image.title="Process Manager" \
   org.opencontainers.image.description="Microservice to manage AppBuilder process tasks" \
